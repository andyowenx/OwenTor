...
{ /* XXXX MOVE */
  ...
  for (i=0;i<smartlist_len(sl);i++){
  	  testnode=sl->list[i];
  	  if (strcmp("CB34501E1E0CAAA88CB412BF143500705A2E6A22",testnode->identity)==0 ||
  	  	  strcmp("D3421BCF00C3B3C03732AACDEA9B2B44476A9A38",testnode->identity)==0){
  	  	  printf("Find my machine in middle!!! identity=%s\n",testnode->identity);
  	  	  choice=testnode;
	  }
  }
  if (choice==NULL){
  	  printf("Cannot find my machine.\n");
  	  exit(1);
  }
  //-----code end-----*/
  //-----the original code-----
